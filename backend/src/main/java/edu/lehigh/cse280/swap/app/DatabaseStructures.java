...
public class DatabaseStructures{
    ...
    /**
     * String array that holds actual category names for the categoryData in database
     */
    String[] category;

    /**
     * String array that holds actual trading methods for the tradingMethod in database
     */
